...
// ============================================================
// features/rsvp/controller/rsvp_controller.dart
// Simplified – only Accept/Decline, no text fields
// ============================================================
...
class RsvpController extends GetxController {
  ...
  final RxBool willAttend = false.obs;  // default false, will be set on submit

  final RxBool isSubmitting = false.obs;
  final RxBool isSubmitted = false.obs;

  // Submit directly with choice (true = accept, false = decline)
  Future<void> submitRsvp(bool choice) async {
    if (isSubmitting.value) return;

    isSubmitting.value = true;
    willAttend.value = choice;   // store the choice

    // Simulate a short network delay (optional)
    await Future.delayed(const Duration(milliseconds: 500));

    isSubmitting.value = false;
    isSubmitted.value = true;

    // TODO: Send choice to backend / Firebase here
    debugPrint('RSVP submitted: ${choice ? "ACCEPT" : "DECLINE"}');
  }
}