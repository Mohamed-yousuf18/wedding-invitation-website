...
// - Sets up GetX (no need for context/BuildContext)
// - Uses GetMaterialApp instead of MaterialApp
// - ScreenUtilInit wraps the app for responsive sizing
// ============================================================
...
class WeddingApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ScreenUtilInit(
      // Base design size — all .sp / .w / .h values scale from this
      // iPhone 14 / standard mobile portrait size
      designSize: const Size(390, 844),

      // Font sizes also scale with screen — prevents tiny text on large screens
      minTextAdapt: true,

      // Proper handling when two apps side-by-side (split screen)
      ...
      builder: (context, child) {
        return GetMaterialApp(
          ...
          // child passed from ScreenUtilInit builder
          home: child,
        );
      },
    );
